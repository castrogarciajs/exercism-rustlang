...
fn main() {
    ...
    // Escribe un programa en Rust que solicite al usuario ingresar un de números enteros. El programa debe contar decir si el número es par y mostrar el resultado al final.
